    ...
    <nav className="border border-b">
      <ul className="flex justify-around items-center p-3 max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-2xl text-primary font-bold hidden md:block">
            BookStore
          </span>
        </Link>
        <li className="flex gap-3 item-center text-center">
          {/* create book */}
          <Link
            to="/create"
          ...
          <div className="w-11">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhDn_X7d69NC11h0ViIyndwNW4DqVRxFS_ng&s"
              alt="profile"
